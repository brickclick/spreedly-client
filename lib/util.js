 ...
 * @returns {Bluebird} Result promise
 */
...
util.normalizeResult = function normalizeResult(result) {
	if(result.authModes && !_.isArray(result.authModes)) {
		result.authModes = [result.authModes];
	}
